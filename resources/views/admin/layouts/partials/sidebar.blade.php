<nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
    <a class="text-decoration-none d-block py-1 px-2 mt-1" href="{{ route('admin.index') }}"><i class="fas fa-home"></i> Home</a>
    ...
    <a class="text-decoration-none d-block py-1 px-2 mt-1" href="{{ route('admin.webSetting.index') }}"><i class="fas fa-tools"></i> Web Setting</a>
</nav>